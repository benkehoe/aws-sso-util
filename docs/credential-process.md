...
4. Streamline the process. If you've got one main AWS SSO configuration, set up your `.bashrc` (or similar) like this:
```
...
Use `aws-sso-util configure profile` to set up your AWS SSO profiles (see the full docs [here](configure.md)).
